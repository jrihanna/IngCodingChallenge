...
insert into user_table (user_id, account_non_expired, account_non_locked, credentials_non_expired , 
			...
			values 
				...
				(2, true, true, true, true,'1234', 'user2','user2', 1, 'user2', 2, 1, 'ROLE_USER'),
				(3, true, true, true, true,'12345', 'user3','user3', 1, 'user3', 2, 1, 'ROLE_USER'),
				(4, true, true, true, true,'123456', 'user4','user4', 1, 'user4', 1, 1, 'ROLE_USER'),
				(5, true, true, true, true,'1234567', 'user5','user5', 1, 'user5', 1, 1, 'ROLE_USER'),
				(6, true, true, true, true,'12345678', 'user6','user6', 1, 'user6', 1, 1, 'ROLE_USER');
